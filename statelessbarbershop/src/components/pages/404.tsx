...
export const Videos = [
  { title: "Stateless", src: "/videos/video1.mp4" },
  { title: "Stateless", src: "/videos/video2.mp4" },
  { title: "Stateless", src: "/videos/video3.mp4" },
  { title: "Stateless", src: "/videos/video4.mp4" },
  { title: "Stateless", src: "/videos/video5.mp4" },
];
